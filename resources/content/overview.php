...
$tpl->assign('show_weather', $tpl->getConfig('main:weather.activation', 'false'));
$tpl->assign('weather', ($tpl->getConfig('main:weather.activation', 'false') == 'true') ? getWeather($tpl->getConfig('main:weather.postcode', 00000)) : '');
...
$tpl->assign('usb_devices', ($tpl->getConfig('main:overview.showDevices', 'true') == 'true') ? rpi_getUsbDevices() : '');
