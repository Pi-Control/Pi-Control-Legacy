...
if (file_exists(PLUGINS_PATH) && is_dir(PLUGINS_PATH))
{
	...
	if (($tpl->getConfig('cron:updateCheck.plugins', 0)+86400) < time() || (isset($_GET['s']) && $_GET['s'] == 'discover_plugins'))
	{
...
$tpl->assign('javascriptReqUrl', urlencode($_SERVER['REQUEST_URI']));
...
$tpl->assign('cronExecutionFault', ($tpl->getConfig('cron:execution.cron', 0)+140 < time()) ? true : false);
